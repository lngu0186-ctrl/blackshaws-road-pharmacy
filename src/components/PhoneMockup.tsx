        ...
        >
          ...
          >
            ...
            <div className="mt-2.5 flex items-center gap-2.5 rounded-2xl bg-[var(--color-navy-soft)] px-4 py-3">
              ...
              <p className="text-[0.88rem] font-medium leading-snug text-[var(--color-text-dark)]">
                Give us a call on <span className="font-bold text-[var(--color-navy-deep)]">03 9391 3257</span>
              </p>
            </div>
            ...
            <div className="mt-4">
              <div className="flex items-center gap-2">
                ...
                <p className="text-[0.85rem] font-bold uppercase tracking-wider text-[var(--color-red)]">ePrescription</p>
              </div>
              <p className="mt-2 text-[0.84rem] font-medium leading-relaxed text-[var(--color-text-dark)]">
                <strong className="font-bold text-[var(--color-navy-deep)]">EMAIL</strong> us a copy of your prescription. Paper scripts require the original hard-copy upon collection.
              </p>
              <p className="mt-1.5 text-[0.84rem] font-medium leading-relaxed text-[var(--color-text-dark)]">
                Or <strong className="font-bold text-[var(--color-navy-deep)]">TEXT/SMS</strong> us your eScript link.
              </p>
            </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              {[
                ...
                <div key={c.label} className="flex items-center gap-2 rounded-xl bg-[var(--color-cream)] px-3 py-2.5">
