  ...
  return (
    <section className="bg-[linear-gradient(135deg,var(--color-navy-deep),var(--color-navy))] py-14 text-white">
      <div className="container-custom">
        <Reveal className="mb-5 flex flex-wrap gap-3">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {facts.map((fact, index) => (
            <Reveal key={fact.title} delay={index * 80} variant="scale" className="h-full">
              <div className="h-full rounded-[28px] border border-white/10 bg-white/6 px-6 py-7 backdrop-blur-sm">
