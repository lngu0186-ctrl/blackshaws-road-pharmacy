...
export const serviceCategories: Record<ServiceCategory, { title: string; description: string }> = {
  ...
  vaccinations: {
    ...
    description: 'Protect yourself and your family with our full vaccination services. Book online or walk in.',
  },
  'medication-management': {
...
export const services: Service[] = [
  ...
  },
  {
    ...
    shortDescription: 'Full cholesterol test with instant results and advice',
    ...
    category: 'health-checks',
    icon: 'heart',
    whoIsItFor: 'Adults interested in heart health, those with family history of cardiovascular disease, or as part of a full health check.',
  ...
  },
  {
    ...
    whatToExpect: 'Fasting (8 hours) recommended. Small finger-prick test. Results in 5 minutes. Full consultation on results and risk factors.',
  ...
  },
  {
    ...
    shortDescription: 'Evaluate your risk of stroke with full screening',
  ...
  },
  {
    ...
    shortDescription: 'Full travel health consultations including vaccines and medications',
    ...
    whatToExpect: 'Full consultation (30 minutes) covering itinerary, required vaccines, medications, and health precautions. Some vaccines require multiple doses over several visits.',
  ...
  // MEDICATION MANAGEMENT
  {
    ...
    shortDescription: 'Full pharmacy review of your medications for safety and effectiveness',
  ...
  // AGED CARE & NDIS
  {
    ...
    shortDescription: 'Full pharmacy support for elderly patients and their carers',
  ...
  // TRAVEL HEALTH
  {
    ...
    whatToExpect: '45-minute full consultation. Itinerary review, medical history, vaccination planning, medication review, and personalised health advice. Some vaccines require multiple doses over several weeks, so early booking is essential.',
  ...
  // HEALTH CHECKS OVERVIEW
  {
    ...
    cost: 'Free BP checks, full panels from $20',
    bookingCTA: 'Walk in for BP check or book for full panel',
    isFree: true,
  ...
  // DIABETES MEDESCHECK
  {
    ...
    whatToExpect: '45-minute private consultation. Full review of all diabetes-related medications, blood glucose monitoring techniques and records, lifestyle factors, and treatment goals. Written report sent to your GP and diabetes care team.',
