...
export const learnArticles: LearnArticle[] = [
  {
    ...
    excerpt:
      'Not sure whether your symptoms need a doctor or whether a pharmacist can help? This guide explains the right care pathway for common conditions, so you get the right help at the right time.',
    date: '2026-04-01',
    readTime: '5 min read',
...
<div class="bg-red-50 border border-red-100 rounded-xl p-6 mt-8">
  ...
  },
  {
    ...
    excerpt:
      'The flu virus changes every year, which is why health authorities recommend annual vaccination. Learn how the vaccine works, who should get it, and why timing matters for best protection.',
    date: '2026-03-28',
    readTime: '6 min read',
...
<p>Book your flu vaccination at Blackshaws Road Pharmacy by calling <a href="tel:0393913257">(03) 9391 3257</a> or walking in during store hours.</p>
  ...
  },
  {
    ...
    excerpt:
      'High blood pressure affects one in three Australian adults. Discover practical lifestyle changes, monitoring tips, and when medication is needed to keep your blood pressure in a healthy range.',
    date: '2026-03-25',
    readTime: '7 min read',
...
<p>Visit Blackshaws Road Pharmacy for free blood pressure checks or to discuss your hypertension management plan. Call <a href="tel:0393913257">(03) 9391 3257</a> to book.</p>
  ...
  },
  {
    ...
    excerpt:
      'MedsCheck is a free, government-funded medication review service. Find out who is eligible, what happens during the consultation, and how it can improve your understanding of your medicines.',
    date: '2026-03-20',
    readTime: '5 min read',
    category: 'Medication Management',
    content: `
<p>MedsCheck is a community pharmacy service designed to help people use their medicines safely and effectively. If you take several medicines, have recently started a new treatment, or feel unsure about what each medicine is for, a MedsCheck can be very worthwhile.</p>
...
<p>If you'd like to book a MedsCheck at Blackshaws Road Pharmacy, call <a href="tel:0393913257">(03) 9391 3257</a> or ask our team in store.</p>
  ...
  },
  {
    ...
    excerpt:
      'Confused by the instructions on your prescription label? This guide breaks down common terminology, repeats, dosage directions, and what to ask your pharmacist when collecting your medicines.',
    date: '2026-03-15',
    readTime: '6 min read',
    category: 'Medication Management',
    content: `
<p>Prescription labels can feel full of shorthand, numbers, and directions that are easy to skim past. But understanding what your script says is one of the best ways to take your medicine safely and confidently.</p>
...
<p>If you have questions about a new or existing prescription, speak to our team at Blackshaws Road Pharmacy or call <a href="tel:0393913257">(03) 9391 3257</a>.</p>
    `.trim(),
  },
]

export const learnArticlesBySlug = Object.fromEntries(
