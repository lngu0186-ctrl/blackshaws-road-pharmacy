      ...
      >
        <div className="container-custom">
          ...
          <div className="mb-6">
            <Link
              to="/services"
              className="inline-flex items-center text-sm opacity-80 hover:opacity-100 transition-colors"
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="tel:0393913257">
                  <Button
                    variant="outline"
                    size="lg"
                    className="text-white border-white hover:bg-white hover:text-[var(--color-navy)]"
                  >
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <Card className="p-8">
                <h2 className="text-2xl font-bold mb-4 flex items-center" style={{ color: 'var(--color-navy)' }}>
                  <Star className="w-6 h-6 mr-3" style={{ color: 'var(--color-red)' }} />
                  Who Is This For?
                </h2>
              ...
              <Card className="p-8">
                <h2 className="text-2xl font-bold mb-4 flex items-center" style={{ color: 'var(--color-navy)' }}>
                  <Calendar className="w-6 h-6 mr-3" style={{ color: 'var(--color-red)' }} />
                  What to Expect
                </h2>
                ...
                <div className="flex flex-wrap gap-3">
                  {service.tags.map((tag) => (
                    <span
                      ...
                      style={{ backgroundColor: 'var(--color-off-white)', color: 'var(--color-navy)' }}
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <Card className="p-6 sticky top-24">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="font-semibold" style={{ color: service.isFree ? 'var(--color-navy)' : 'var(--color-red)' }}>
                      {service.cost}
                    </p>
                  </div>
                  <div>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <p className="text-sm text-[var(--color-gray-600)] mb-4">
                    Have questions? Call us or visit the store.
                  </p>
